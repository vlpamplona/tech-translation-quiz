...
*   **Tratamento de Erros:** Tratamento de exceções robusto para erros de cota (`Quota exceeded`), garantindo que o programa informe o utilizador em vez de falhar abruptamente.
...
3.  No código python, informe sua chave API KEY gerada

### 2. Como Funciona
O script faz uma chamada única ao modelo gemini-1.5-flash para obter a lista de termos. Se a cota gratuita do Google estiver esgotada no momento, o código captura o erro e avisa o utilizador de forma amigável.
